...
import { Heading } from '@rhino-ui/components';
...
```js codesandbox=rhinolabs-components
import React from 'react';
import { Heading, FONT_SIZE_OPTIONS } from '@rhino-ui/components';
...
```js codesandbox=rhinolabs-components
import React from 'react';
import { Heading, FONT_COLOR_OPTIONS } from '@rhino-ui/components';
