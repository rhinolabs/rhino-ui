...
<Canvas>
  <Story name="Without Icon">
    {() => {
      ...
      return <FileUpload labelText="My File" id="myFile" onChange={handleChange} files={files} hasIcon={false} />;
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Without Button Text">
    {() => {
      ...
      return <FileUpload labelText="My File" id="myFile" onChange={handleChange} files={files} buttonText={null} />;
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Truncated File Names">
    {() => {
      ...
      return (
        <FileUpload labelText="My File" id="myFile" onChange={handleChange} files={files} fileNameMaxLength={16} />
      );
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Full Width">
    {() => {
      ...
      return <FileUpload labelText="My File" id="myFile" onChange={handleChange} files={files} fullWidth />;
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Disabled">
    {() => {
      ...
      return <FileUpload labelText="My File" id="myFile" onChange={handleChange} files={files} isDisabled />;
    }}
  </Story>
</Canvas>
    ...
    {() => {
      ...
      return (
        <Box gap="md" direction="row">
          ...
          />
          <div>
            <Button onClick={handleSubmit}>Submit with no files to see error.</Button>
          </div>
        </Box>
      );
    }}
