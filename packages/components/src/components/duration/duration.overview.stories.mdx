  ...
  <Story name="Hover" withSource="open">
    {() => {
      ...
      const popoverContent = (
        <>
          <p>
            <Duration milliseconds={86500000} displayMinutes={10000000000} /> or{" "}
            <Duration milliseconds={86500000} displayHours={10000000000} /> or{" "}
            <Duration milliseconds={86500000} displayDays={10000000000} />
          </p>
        </>
      );
      useEffect(() => {
          ...
          >
            <Box padding="sm">
              <Badge
                ...
                message={<Duration milliseconds={86500000} />}
                variant="default"
              />
            </Box>
          </Popover>
