...
<Canvas>
  <Box background="grey-lightest" padding="2xl">
    <Card>
      ...
      <Card.Footer>
        <Box display="flex" direction="row" justify="between" overflow="hidden" gap="md">
...
<Canvas>
  <Story
    ...
    parameters={{
      design: {
        type: "figma",
        url: "https://www.figma.com/file/k1kOsplTGXvSSMQQCzhCND/Rhinolabs-Design-System?node-id=548%3A7658",
      },
    }}
  >
    <Card>
