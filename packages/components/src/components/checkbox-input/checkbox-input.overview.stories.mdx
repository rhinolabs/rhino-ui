...
<Canvas>
  <Story name="States">
    {() => {
      return (
        <Box gap="md">
          <CheckboxInput id="statesUnchecked" label="Unchecked" onChange={() => {}} isChecked={false} />
          <CheckboxInput id="statesCHecked" label="Checked" onChange={() => {}} isChecked={true} />
          <CheckboxInput
            id="statesUnchecked"
            label="Indeterminate"
            onChange={() => {}}
        ...
        <Box direction="row" alignItems="center">
          ...
          <FormLabel inputId="customLabel">
            <Box display="block" fontSize="xl" color="secondary-500">
              ...
              <a href="https://rhinolabs.agency" onClick={() => alert("hey you clicked me!")} target="_blank">
                Link
              </a>
            </Box>
          </FormLabel>
